...
- [Attribution](./attribution.md) — `date = date`, `source = source`, `medium = medium`, `campaign = campaign`, `targeting_country = targeting_country` [1:N] — The acquisition funnel this day of spend paid for.
