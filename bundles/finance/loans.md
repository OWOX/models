...
- [Customer](./customer.md) — `customer_id = customer_id` [N:1] — The customer who applied for this loan.
- [Product](./product.md) — `product_id = product_id` [N:1] — The lending product applied for.
