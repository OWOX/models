...
| `campaign_id` | STRING | Campaign ID | Campaign this spend belongs to. FK to [Campaign](./campaign.md) |
...
- [Campaign](./campaign.md) — `campaign_id = campaign_id` [N:1] — The campaign this spend was bought for.
